...
import WeatherInformationTiles from "../../components/WeatherInformationTiles";

describe("<WeatherInformationTiles />", () => {
  it("should render a forecast-tiles container div", () => {
    const wrapper = render(<WeatherInformationTiles store={mockStore()} forecasts={list}/>);
